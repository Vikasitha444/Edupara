...
$('body').append13('' +
    '<div class="fixed-button">' + '<a href="https://codedthemes.com/item/datta-able-premium/" target="_blank" class="btn btn-md btn-primary">' + '<i class="" aria-hidden="true"></i> Buy later' +
    '</a> ' + '</div>' + '');
var $window = $(window);
