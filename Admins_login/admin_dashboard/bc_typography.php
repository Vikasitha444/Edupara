                                                            ...
                                                            <aside class="lg-side">
                                                                ...
                                                                <div class="inbox-body">
                                                                    ...
                                                                    <table class="table table-inbox table-hover">
                                                                        <tbody>
                                                                            <?php
                                                                                $sql1 = "   SELECT message_id, Name, Email, Phone_number, whatsapp_number, message_content, recived_date, recived_time, Readability FROM contact_us_messages
                                                                                            WHERE Name != '' or Email != '' or Phone_number != '' or whatsapp_number != '' or message_content != ''
                                                                                ...
                                                                                while ($row1 = mysqli_fetch_assoc($resalt1)) {
                                                                                    ...
                                                                                    for ($i=0; $i < count($datas1); $i++) { 
                                                                                        $contact_us_message_id = $datas1[$i]['message_id'];
                                                                                        $contact_us_name = $datas1[$i]['Name'];
                                                                                        $contact_us_email = $datas1[$i]['Email'];
                                                                                        $contact_us_phone_number = $datas1[$i]['Phone_number'];
                                                                                        $contact_us_whatsapp_number = $datas1[$i]['whatsapp_number'];
                                                                                        $contact_us_message_content = $datas1[$i]['message_content'];
                                                                                        $contact_us_recived_date = $datas1[$i]['recived_date'];
                                                                                        $contact_us_recived_time = $datas1[$i]['recived_time'];
                                                                                        $readability = $datas1[$i]['Readability'];
                                                                                        
                                                                                        //Config settings
                                                                                        $readability == 'unread'?$readability = NULL : $readability = 'unread'; //the meaning of unread is, getting message unreadable, it means user already has read that message
                                                                                        $contact_us_message_content = substr($contact_us_message_content,0,43);
                                                                                        $contact_us_email != '' || $contact_us_email != NULL? $contact_us_email = "$contact_us_email" : $contact_us_email = " &ltno-reply@nomail.lk&gt";
                                                                                        $contact_us_name != '' || $contact_us_name != NULL? $contact_us_name = "$contact_us_name" : $contact_us_name = " &ltno-name&gt";
                                                                                        $contact_us_message_content != '' || $contact_us_message_content != NULL? $contact_us_message_content = "$contact_us_message_content" : $contact_us_message_content = " &ltno-content&gt";
                                                                                        $i == 0 && $readability == NULL? $label = "<span class='label label-info pull-right'>first</span>" : $label = "";
                                                                                        
                                                                                            echo
                                                                                            "<tr class='$readability message_row' id='$contact_us_message_id'>
                                                                                                <td class='inbox-small-cells'>
                                                                                                    <input type='checkbox' class='mail-checkbox'>
                                                                                                </td>
                                                                                                <td class='inbox-small-cells'><i class='fa fa-star'></i></td>
                                                                                                <td class='view-message  dont-show'>$contact_us_name $label</td>
                                                                                                <td class='view-message '>$contact_us_email</td>
                                                                                                <td class='view-message  inbox-small-cells'>$contact_us_message_content...</td>
                                                                                                <td class='view-message  text-right'>$contact_us_recived_time</td>
                                                                                            </tr>";
                                                                            ...
                                                                            <script>
                                                                                $(function(){
                                                                                    $('.message_row').click(function(){
                                                                                        $(this).attr('class','unread message_row');
                                                                                        var m_id = $(this).attr('id');
                                                                                        window.location.replace('./bc_typography - 2.php?m_id='+m_id);
                                                                                    });
                                                                                });
                                                                            </script>
